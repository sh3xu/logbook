            ...
            {notifications.length === 0 ? (
              <div className="p-12 text-center">
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-tighter">
                  No signals currently in buffer.
                </p>
              </div>
            ) : (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <p
                        className={`text-sm font-bold uppercase tracking-tight transition-colors ${!notif.read ? "text-black" : "text-gray-400"}`}
                      >
                        {notif.message}
                      </p>
                      <div className="flex items-center gap-2">
                        ...
                        {!notif.read && (
                          <span className="px-1.5 py-0.5 border-[1px] border-[#FF2E63] text-[8px] font-black text-[#FF2E63] uppercase">
                            New Signal
                          </span>
                        )}
                      </div>
