...
export default function KeySection({
  ...
  return (
    <div className="relative">
      ...
      >
        {encryptionKey ? (
          <Unlock className="w-4 h-4 md:w-6 md:h-6" />
        ) : (
              ...
              {!isUpdating ? (
                <>
                  <div className="flex items-center gap-3 p-3 bg-green-50 border-[2px] border-black">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-green-600 italic">
                        Data stream is live
                      </div>
                    </div>
                  </div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase leading-tight italic">
                    Your master key is active for this session. Closing the tab
                    will flush your access.
                  </p>
                  <button
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="p-3 bg-red-50 border-[2px] border-dashed border-red-400">
                    <p className="text-[10px] font-black text-red-600 uppercase mb-1 flex items-center gap-1">
                      <AlertTriangle size={12} /> Critical Warning
                    </p>
                    <p className="text-[9px] font-bold text-red-500 leading-tight italic">
                      Updating your key will re-encrypt ALL previous entries. Do
                      not interrupt this process once started.
                    </p>
                  </div>
                  ...
                  {error && (
                    <div className="text-red-600 text-[10px] font-black uppercase">
                      {error}
                    </div>
                  )}
                  <button
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 bg-gray-50 border-[2px] border-black">
                <p className="text-[9px] text-gray-500 font-bold uppercase italic leading-tight">
                  Your identity is verified via zero-knowledge proof. Plaintext
